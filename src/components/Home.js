    ...
    return (
        <div name="home" id="hm" className="w-full h-screen">
            ...
            <div className="max-w-[1000px] h-full mx-auto px-8 flex flex-col justify-center text-white text-center ">
                ...
                <h1 className="p-4 mb-3 font-semibold text-3xl md:text-4xl">A <span className="text-[#0a192f]">Web</span> Developer.</h1>
                <p className='pb-6 text-lg font-semibold md:text-xl'>My expertise lie in <span className="text-[#0a192f]">React</span> and <span className="text-[#0a192f]">WordPress</span>.</p>
                <p className='pb-6 text-lg font-semibold md:text-xl'>I love to talk and explore about <span className="text-[#0a192f]">Frontend</span>.</p>
                <div>
